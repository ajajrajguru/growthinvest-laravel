...
@endphp
  <tr class="">
      ...
      <td  width="10%">
          {{ (!empty($transferasset->company))? $transferasset->company->name :'' }}
      </td>
      ...
      <td class="subheader_cell-cust" width="9%">
          {{ (isset($details['assets_nameonsharecertificate']))? $details['assets_nameonsharecertificate'] :'' }}
      </td>
      <td class="subheader_cell-cust" width="9%">
      ...
      <td class="subheader_cell-cust" width="9%">
           {{ (isset($details['typeoftransfer']))? $details['typeoftransfer'] :'' }}
      </td>
      <td class="subheader_cell-cust" width="9%">
          {{ (isset($details['assets_aicustody']))? $details['assets_aicustody'] :'' }}
      </td>
      <td class="subheader_cell-cust" width="9%">
