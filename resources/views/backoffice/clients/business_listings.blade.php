                        ...
                        <div class="row ">
                            <div class="col-md-12 mb-5">
                                ...
                                <select name="managebusiness_type" class="form-control " id="managebusiness_type">
                                       <option value="business-listings" @if(invest_listings=="no") selected @endif  >Business Proposals/Funds</option>              
                                       ...
                                       <option value="view-invest-listings" @if(invest_listings=="yes") selected @endif >Invest Companies</option> 
                                </select>
                            </div>
