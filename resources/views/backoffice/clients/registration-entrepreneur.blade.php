        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade show active" id="add_clients" role="tabpanel">
                ...
                <div class="p-2">
                    <div class="row mb-4">
                        <div class="col-md-5">
                            <h1 class="section-title font-weight-medium text-primary mt-4 mb-0">Add Entrepreneur</h1>
                            <p class="text-muted">Add details of Entrepreneur.</p>
                        </div>
                ...
                <div class="profile-content p-4">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="">
                            ...
                            <a href="{{ url('backoffice/investor/'.$entrepreneur->gi_code.'/client-categorisation')}}" class="btn btn-primary mb-4">Next<i class="fa fa-angle-double-right"></i></a> 
                            @endif
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="company" class="form-control editmode @if($mode=='view') d-none @endif"   placeholder="" value="{{ ($entrepreneur->id) ? $entrepreneur->email :old('email')}}">
                            <span class="viewmode @if($mode=='edit') d-none @endif">{{ }}</span>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="website" class="form-control editmode @if($mode=='view') d-none @endif" placeholder="Eg: 020 7071 3945" value="{{ ($entrepreneur->id) ? $entrepreneur->telephone_no :old('telephone') }}">
                            <span class="viewmode @if($mode=='edit') d-none @endif">{{}}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>Custom Email Content <span class="text-danger reqField @if($mode=='view') d-none @endif">*</span></label>
                ...
                @if($entrepreneur->id)
                <a href="{{ url('backoffice/investor/'.$entrepreneur->gi_code.'/client-categorisation')}}" class="btn btn-primary mt-3 ">Next</a> 
                @endif
