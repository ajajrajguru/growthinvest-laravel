...
@if(!$invHasCertification) Certification @else Re-Certification @endif of {{ $certificationOf }}  of Firm <b><i>{{ $firmName }}</i></b> has been confirmed.<br/><br/>
...
<strong>Certification done by:</strong> {{ $certificationBy }}<br><br>
