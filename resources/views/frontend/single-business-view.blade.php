...
<script type="text/javascript" src="{{ asset('js/frontoffice.js') }}"></script>
...
<div class="container pb-5">
	...
	<div class="row mt-3 mb-3">
		...
		<div class="col-sm-4 text-center mt-2 mt-sm-0">
			<a href="" class="btn btn-primary btn-lg btn-invest-now" data-businesstype="{{$type}}" 
					data-userid="{{$user_id}}" data-businessid="{{$id}}" data-toggle="modal" data1-target="#exampleModal2"> Invest Now</a>
		</div>
	</div>
...
@php
        ...
        /* echo View::make('invest-modal.invest-modal')->with(["user"=>'']) */
@endphp
